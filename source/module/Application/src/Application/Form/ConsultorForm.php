...
class ConsultorForm extends AbstractForm{

    public function __construct($_name = 'Salvar') {

        parent::__construct($_name);

        $this->setInputFilter((new Filter\ConsultorFilter())->getInputFilter());
        ...
        //Confirmar senha
        $comfirmarSenha = new Element\Password('confirmar-senha');
