...
class Usuario extends \Application\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Usuario' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Usuario' . "\0" . 'nome', '' . "\0" . 'Application\\Entity\\Usuario' . "\0" . 'email', '' . "\0" . 'Application\\Entity\\Usuario' . "\0" . 'senha', '' . "\0" . 'Application\\Entity\\Usuario' . "\0" . 'cadastradoEm', '' . "\0" . 'Application\\Entity\\Usuario' . "\0" . 'ultimoAcesso', '' . "\0" . 'Application\\Entity\\Usuario' . "\0" . 'tipo', '' . "\0" . 'Application\\Entity\\Usuario' . "\0" . 'ativo', '' . "\0" . 'Application\\Entity\\Usuario' . "\0" . 'hash', '' . "\0" . 'Application\\Entity\\Usuario' . "\0" . 'cliente'];
        }
