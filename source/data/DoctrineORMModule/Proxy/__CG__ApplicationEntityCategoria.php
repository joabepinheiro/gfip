...
class Categoria extends \Application\Entity\Categoria implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Categoria' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Categoria' . "\0" . 'nome', '' . "\0" . 'Application\\Entity\\Categoria' . "\0" . 'tipo', '' . "\0" . 'Application\\Entity\\Categoria' . "\0" . 'ativo', '' . "\0" . 'Application\\Entity\\Categoria' . "\0" . 'cliente'];
        }
