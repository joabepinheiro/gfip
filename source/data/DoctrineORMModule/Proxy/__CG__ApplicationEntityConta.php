...
class Conta extends \Application\Entity\Conta implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Conta' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Conta' . "\0" . 'nome', '' . "\0" . 'Application\\Entity\\Conta' . "\0" . 'tipo', '' . "\0" . 'Application\\Entity\\Conta' . "\0" . 'saldo', '' . "\0" . 'Application\\Entity\\Conta' . "\0" . 'ativo', '' . "\0" . 'Application\\Entity\\Conta' . "\0" . 'cliente'];
        }
